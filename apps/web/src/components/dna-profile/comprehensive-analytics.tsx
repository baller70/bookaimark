    ...
    try {
      ...
      const mockData: AnalyticsData = {
        ...
        timeTracking: {
          ...
          peakHours: [
            { hour: '9-10 AM', productivity: 92 },
            { hour: '2-3 PM', productivity: 87 },
            { hour: '10-11 AM', productivity: 84 }
          ],
          totalHours: 126.5
        },
        bookmarkInsights: {
          topPerformers: [
            { name: 'React Documentation', visits: 156, timeSpent: 24.3, productivity: 94 },
            { name: 'TypeScript Handbook', visits: 134, timeSpent: 18.7, productivity: 89 },
            { name: 'Next.js Guide', visits: 98, timeSpent: 15.2, productivity: 86 }
          ],
          underperformers: [
            { name: 'Old Tutorial Site', visits: 2, lastVisited: '45 days ago', category: 'Learning' },
            { name: 'Deprecated API Docs', visits: 1, lastVisited: '62 days ago', category: 'Reference' }
          ],
          unusedBookmarks: [
            { name: 'Unused Design Tool', daysUnused: 89, category: 'Design' },
            { name: 'Old Framework Docs', daysUnused: 67, category: 'Development' },
            { name: 'Outdated News Site', daysUnused: 45, category: 'News' },
            { name: 'Legacy Resource', daysUnused: 34, category: 'Reference' },
            { name: 'Abandoned Project', daysUnused: 23, category: 'Projects' }
          ]
        },
        categoryAnalysis: {
          categories: [
            { name: 'Development', efficiency: 92, timeSpent: 45.2, bookmarkCount: 89 },
            { name: 'Design', efficiency: 78, timeSpent: 23.1, bookmarkCount: 34 },
            { name: 'Learning', efficiency: 85, timeSpent: 31.4, bookmarkCount: 56 },
            { name: 'Reference', efficiency: 71, timeSpent: 18.9, bookmarkCount: 42 }
          ],
          productivityByCategory: [
            { category: 'Development', score: 92 },
            { category: 'Learning', score: 85 },
            { category: 'Design', score: 78 },
            { category: 'Reference', score: 71 }
          ]
        },
        projectManagement: {
          activeProjects: [
            { name: 'E-commerce Platform', progress: 78, deadline: '2024-02-15', status: 'On Track' },
            { name: 'Mobile App Redesign', progress: 45, deadline: '2024-02-28', status: 'At Risk' },
            { name: 'API Integration', progress: 92, deadline: '2024-02-10', status: 'Ahead' }
          ],
          resourceAllocation: [
            { resource: 'Development Time', utilization: 85 },
            { resource: 'Research Time', utilization: 62 },
            { resource: 'Design Time', utilization: 73 }
          ]
        },
        smartRecommendations: {
          cleanup: [
            { type: 'Unused Bookmarks', count: 23, impact: 'High - Reduce clutter' },
            { type: 'Duplicate Categories', count: 5, impact: 'Medium - Improve organization' },
            { type: 'Broken Links', count: 8, impact: 'High - Fix or remove' }
          ],
          optimization: [
            { suggestion: 'Merge similar categories', benefit: 'Better organization', effort: 'Low' },
            { suggestion: 'Add time tracking to top bookmarks', benefit: 'Improved insights', effort: 'Medium' },
            { suggestion: 'Create project-specific folders', benefit: 'Better workflow', effort: 'Low' }
          ],
          trending: [
            { item: 'AI Tools', growth: 45, category: 'Development' },
            { item: 'React Hooks', growth: 32, category: 'Learning' },
            { item: 'Design Systems', growth: 28, category: 'Design' }
          ]
        }
      }
      setData(mockData)
