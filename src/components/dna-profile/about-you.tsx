...
export function AboutYouComponent({ onProfileUpdate }: AboutYouComponentProps) {
      ...
      try {
        ...
        if (error || !user) {
          toast({
            ...
            description: "Sign in to save your profile to the cloud and sync across devices.",
          })
        }
      } catch (error) {
  ...
  const loadProfile = async () => {
    try {
      ...
      console.warn('Database not available, using default profile:', error)
      // Use default profile when database is not available
      setProfile(defaultProfile)
    } finally {
      setLoading(false)
    }
  ...
  const saveProfile = async () => {
    ...
    try {
      ...
      toast({
          ...
          description: "Your profile has been saved to this device. Sign in to save to the cloud.",
      })
      ...
      toast({
        ...
        description: "Your DNA profile has been updated.",
      })
